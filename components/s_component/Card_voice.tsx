...
const Card_voice=(data:interfaceVoice )=>{
    return (
        <section className='w-[95%]  gap-5 lg:gap-0 lg:w-60 lg:h-52 border-r-8 border-b-8 border-footer border-2 rounded-lg relative flex flex-col  items-center text-footer'>
